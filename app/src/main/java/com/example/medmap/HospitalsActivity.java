...
public class HospitalsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(v -> {
            ...
            if (!location.isEmpty()) {
                ...
                Toast.makeText(HospitalsActivity.this, "Please enter a location", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(marker -> {
            ...
            if (details != null) {
                Toast.makeText(HospitalsActivity.this, details, Toast.LENGTH_LONG).show();
            }
            return false;
        });
    }
                ...
                fusedLocationProviderClient.getLastLocation()
                        .addOnSuccessListener(this, location -> {
                            if (location != null) {
                                ...
                                Log.e("HospitalsActivity", "Current location is null");
                                Toast.makeText(HospitalsActivity.this, "Unable to determine current location", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .addOnFailureListener(e -> {
                            Log.e("HospitalsActivity", "Error trying to get last location", e);
                        });
            }
        } catch (SecurityException e) {
            Log.e("HospitalsActivity", "SecurityException: " + e.getMessage());
        }
    }
