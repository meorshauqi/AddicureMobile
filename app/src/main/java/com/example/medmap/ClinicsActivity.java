...
public class ClinicsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(v -> {
            ...
            if (!location.isEmpty()) {
                ...
                Toast.makeText(ClinicsActivity.this, "Please enter a location", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(marker -> {
            ...
            if (details != null) {
                Toast.makeText(ClinicsActivity.this, details, Toast.LENGTH_LONG).show();
            }
            return false;
        });
    }
                ...
                fusedLocationProviderClient.getLastLocation()
                        .addOnSuccessListener(this, location -> {
                            if (location != null) {
                                ...
                                // Find nearby clinics
                                findNearbyClinics(currentLocation);
                            } else {
                                Log.e("ClinicsActivity", "Current location is null");
                                Toast.makeText(ClinicsActivity.this, "Unable to determine current location", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .addOnFailureListener(e -> {
                            Log.e("ClinicsActivity", "Error trying to get last location", e);
                        });
            }
        } catch (SecurityException e) {
            Log.e("ClinicsActivity", "SecurityException: " + e.getMessage());
        }
    }

    private void findNearbyClinics(LatLng location) {
